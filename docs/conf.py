...
htmlhelp_basename = 'django-oauth2doc'
...
latex_documents = [
  ('index', 'django-oauth2.tex', u'django-oauth2 Documentation',
...
man_pages = [
    ('index', 'django-oauth2', u'django-oauth2 Documentation',
