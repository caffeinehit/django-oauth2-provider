...
from provider.compat import user_model_label, user_model_db_table
...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        user_model_label: {
            'Meta': {'object_name': user_model_label.split('.')[-1], 'db_table': "'{}'".format(user_model_db_table())},
        ...
        'oauth2.refreshtoken': {
            ...
            'access_token': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'refresh_token'", 'unique': 'True', 'to': "orm['%s']" % user_model_label}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['oauth2.Client']"}),
